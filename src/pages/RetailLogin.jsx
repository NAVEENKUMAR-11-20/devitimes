...
const RetailLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await loginRetailUser(username.trim(), password);
      if (response.success) navigate('/retail');
    ...
    <div className="auth-split-page">
      ...
      <div className="auth-brand-panel">
        <div className="auth-brand-inner">
          ...
          <h1 className="auth-panel-brand font-logo">RETAIL PORTAL</h1>
          <p className="auth-panel-tagline font-heading">Exclusive Retail Collection</p>

          <div className="auth-panel-divider"/>

          <p className="auth-panel-desc font-body">
            Sign in to access the retail catalog and pricing.
          </p>

          <div className="auth-panel-badges">
            <span className="auth-badge">✦ Retail Pricing</span>
      ...
      <div className="auth-form-panel">
        <div className="auth-form-inner animate-fade-in">
          ...
          <div className="auth-form-header">
            <h2 className="auth-form-title font-heading">Retail Login</h2>
            <p className="auth-form-subtitle font-body">Sign in with your retail staff credentials</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-input" id="login-userid" placeholder="Enter your username"
