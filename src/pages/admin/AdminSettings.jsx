...
const AdminSettings = () => {
  ...
  const [retailUserId, setRetailUserId] = useState(settings.retailUserId || '');
  const [retailPassword, setRetailPassword] = useState(settings.retailPassword || '');
          ...
          <form onSubmit={handleSaveRetailCredentials} className="admin-form settings-compact-form">
            <div className="form-group settings-form-group">
              ...
              <input
                type="text"
                className="form-input settings-input"
                placeholder="Enter retail user ID"
                value={retailUserId}
            ...
            <div className="form-group settings-form-group">
              ...
              <input
                type="text"
                className="form-input settings-input"
                placeholder="Enter retail password"
